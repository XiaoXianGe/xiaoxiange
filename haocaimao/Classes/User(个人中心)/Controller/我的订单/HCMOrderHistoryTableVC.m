...
@interface HCMOrderHistoryTableVC ()
...
@implementation HCMOrderHistoryTableVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HCMNonPaymentCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if (!cell) {
        cell = [[HCMNonPaymentCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UIImageView *imageView = (UIImageView *)[headView viewWithTag:69];
    ...
    if (headView == nil) {
        ...
        CGRect imageRECT = CGRectMake(240, 15, 70, 55);
