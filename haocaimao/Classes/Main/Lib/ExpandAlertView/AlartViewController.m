...
- (void)viewDidLoad
{
    ...
    self.titleView = [[UIView alloc] initWithFrame:CGRectMake((HCMScreenWidth - 280)/2, -70, 280, 120)];
    ...
    cancelButton = [[UIButton alloc] initWithFrame:CGRectMake((HCMScreenWidth - 30)/2, 600, 30, 30)];
...
//            [titleLabel setText:@" 确 定 ？"];
        ...
        {
            [titleLabel setText:@" 成 功 ！"];
            [self performSelector:@selector(cancelAction) withObject:self afterDelay:0.25];
        }
    }
}
